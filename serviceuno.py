...
class Ui_lastWindow(object):
    def setupUi(self, lastWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(350, 460, 100, 40))
        font2 = QtGui.QFont()
        font2.setPointSize(14)
        self.pushButton.setFont(font2)
        self.pushButton.setObjectName("pushButton")
        self.pushButton2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton2.setGeometry(QtCore.QRect(580, 460, 100, 40))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(380, 90, 220, 40))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit.setFont(font)
        self.lineEdit2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit2.setGeometry(QtCore.QRect(380, 150, 220, 40))
        self.lineEdit2.setObjectName("lineEdit2")
        self.lineEdit2.setFont(font)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(150, 90, 180, 40))
        self.label.setFont(font)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(30, 200, 800, 100))
        self.label_2.setObjectName("label_2")
        self.label_2.setFont(font2)
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(310, 0, 300, 70))
        ...
        self.label_4.setGeometry(QtCore.QRect(300, 300, 400, 120))
        self.label_4.setObjectName("label_4")
        self.label_4.setFont(font)
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(150, 150, 180, 40))
    ...
    def retranslateUi(self, lastWindow):
        ...
        lastWindow.setWindowTitle(_translate("lastWindow", "ServiceUno"))
...
class Ui_thirdWindow(object):
    ...
    def setupUi(self, thirdWindow):
        ...
        thirdWindow.setStyleSheet(open('style.qss').read())
        ...
        self.radioButton_6.setGeometry(QtCore.QRect(350, 20, 50, 50))
        ...
        self.radioButton_7.setGeometry(QtCore.QRect(410, 20, 50, 50))
        ...
        self.radioButton_8.setGeometry(QtCore.QRect(470, 20, 50, 50))
        ...
        self.radioButton_9.setGeometry(QtCore.QRect(530, 20, 50, 50))
        ...
        self.radioButton_10.setGeometry(QtCore.QRect(590, 20, 55, 50))
        ...
        self.radioButton_5.setGeometry(QtCore.QRect(290, 20, 50, 50))
        ...
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 30, 800, 151))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, thirdWindow):
        _translate = QtCore.QCoreApplication.translate
        thirdWindow.setWindowTitle(_translate("thirdWindow", "ServiceUno"))
        ...
        for items in chk:
            if items.isChecked():
                ...
                if j[0] == 1:
                    ...
                    #print(config.score)
                    print("Q8", config.score[7], j[0],config.score[7])
        ...
        for items in chk:
            if items.isChecked():
                ...
                if j[1] == 1:
                    ...
                    #print(config.score)
                    print("Q9", config.score[8], j[1],config.score[8])
        ...
        for items in chk:
            if items.isChecked():
                ...
                if j[2] == 1:
                    ...
                    print("Q10", config.score[9], j[2],config.score[9])
                    print(config.score)
                self.label.setText("")
        self.groupBox.hide()
        #self.openWindow()
...
class Ui_newWindow(object):
    ...
    def setupUi(self, newWindow):
        ...
        newWindow.setStyleSheet(open('style.qss').read())
    ...
    def retranslateUi(self, newWindow):
        _translate = QtCore.QCoreApplication.translate
        newWindow.setWindowTitle(_translate("newWindow", "ServiceUno"))
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(270, 40, 260, 91))
        font = QtGui.QFont()
        font.setPointSize(28)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(310, 460, 180, 40))
        self.pushButton.setObjectName("pushButton")
        font2 = QtGui.QFont()
        font2.setPointSize(14)
        self.pushButton.setFont(font2)
        ...
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(235, 140, 330, 291))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(0, 0, 800, 600))
        self.label_3.setObjectName("label_3")
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "ServiceUno"))
        self.label.setText(_translate("MainWindow", "Welcome to"))
        self.pushButton.setText(_translate("MainWindow", "Start rating!"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/newPrefix/uno.png\"/></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/newPrefix/bg.jpg\"/></p></body></html>"))
